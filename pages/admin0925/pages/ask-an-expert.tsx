// /pages/admin0925/pages/ask-an-expert.tsx
...
const AskAnExpertEditor = () => {
  ...
  useEffect(() => {
    // Load current data
    setPageData(StaticPageData['ask-an-expert']);
  }, []);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage('✅ Ask an Expert page updated successfully!');
      } else {
  ...
  return (
    <>
      <SectionHeader
        title="Edit Ask an Expert / Contact Us Page"
        subtitle="Update the content that appears on /ask-an-expert (form remains unchanged)"
      />
      ...
      <div className="bg-white p-6 rounded-lg shadow-md space-y-6 mt-6">
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
          <p className="text-sm text-blue-800">
            ...
            The contact form and page layout are controlled by the code in <code>/pages/ask-an-expert.tsx</code>
          </p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
            placeholder="e.g., Contact Us | InsuranceSmartCalculator"
          />
          <p className="text-xs text-gray-500 mt-1">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
            rows={3}
            placeholder="e.g., Get in touch with our insurance experts..."
          />
          <p className="text-xs text-gray-500 mt-1">
...
export default withAuth(AskAnExpertEditor);